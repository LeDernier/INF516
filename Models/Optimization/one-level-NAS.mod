# one-level-NAS_optimization.mod
...
set T_1 := 1..n1;          # indices of the 1st coordinate of the training set 
set T_2 := 1..n2;			# indices of the 2nd coordinate of the training set
...
set GIO := {I,O};
#set G := GIH union GHO;
set G := {i in V,j in V: j > i}; 			# set of possible connections in a DAG (induced asymmetry)
...
var z{T,V} binary;			# auxiliary variable to have v_plus <= 0 xor v_minus <= 0	
var A{G};					# weights NN
